...
public class Order_Adapter extends RecyclerView.Adapter<Order_Adapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txt_price.setText(String.valueOf(orderModel.getPrice())); // Hiển thị giá
        holder.imageView.setImageResource(R.drawable.so_do); // Thay bằng ảnh thích hợp nếu có
