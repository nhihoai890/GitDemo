...
public class Cart_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        sale_layout = view.findViewById(R.id.sale_layout);
        ...
        sale_layout.setOnClickListener(v -> {
           BottomSheetDialog bottomSheetDialog = new BottomSheetDialog(getContext());
           View dialogView_1 = LayoutInflater.from(getContext()).inflate(R.layout.dialog_sale, null);
            bottomSheetDialog.setContentView(dialogView_1);
            bottomSheetDialog.show();
