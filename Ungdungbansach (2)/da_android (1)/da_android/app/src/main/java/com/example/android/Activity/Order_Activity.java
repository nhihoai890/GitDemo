...
public class Order_Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        orderModels.add(new Order_model(1, 100000, 200, 2, "Hacker Toeic", "David Cho"));
        orderModels.add(new Order_model(2, 100000, 200, 2, "Trôi", "Nguyễn Ngọc Tư"));
        orderModels.add(new Order_model(2, 100000, 200, 2, "Harry Potter 4", "J.K Rowling"));
