...
public class Home_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        bookModels.add(new Book_model(1, 100000, 200, 2, 4 / 5, "Số Đỏ", "Vũ Trọng Phụng", "Sách hay", "so_do"));
        bookModels.add(new Book_model(2, 100000, 200, 2, 5 / 5, "Số Đỏ", "Vũ Trọng Phụng", "Sách hay", "so_do"));
        bookModels.add(new Book_model(3, 100000, 200, 2, 5 / 5, "Số Đỏ", "Vũ Trọng Phụng", "Sách hay", "so_do"));
