...
public class Cart_Fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        cartModels.add(new Cart_Model(1, 100000, 2, "Số đỏ", "Vũ Trọng Phụng", "Vũ Trọng Phụng"));
        cartModels.add(new Cart_Model(2, 100000, 1, "Số đỏ", "Vũ Trọng Phụng", "Vũ Trọng Phụng"));
        cartModels.add(new Cart_Model(3, 100000, 1, "Số đỏ", "Vũ Trọng Phụng", "Vũ Trọng Phụng"));
